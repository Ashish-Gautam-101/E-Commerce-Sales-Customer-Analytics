...
This project analyzes **sales performance, customer behavior, products, categories, sellers, payments, reviews, and order trends** using **Python, MySQL, SQL, and Power BI**.

The workflow covers data loading, validation, cleaning, exploratory analysis, advanced SQL, dashboard visualization, and business insights.
...
Python is used to load and verify the CSV datasets in MySQL.
...
> The `.pbix` Power BI file is not included because of its large file size. Dashboard screenshots are available in the `Z_Images/` folder.

## Dashboard Preview

### Executive Dashboard

![Executive Dashboard](Z_Images/executive_dashboard.png)

### Customer Analysis

![Customer Analysis](Z_Images/customer_analysis.png)

### Product Analysis

![Product Analysis](Z_Images/product_analysis.png)

### Seller Performance

![Seller Performance](Z_Images/seller_performance.png)
...
1. Approximately **16.01M total revenue** is reported from approximately **99K orders** and **96K customers**.
2. The overall **Average Order Value is 160.99**.
3. The overall **Average Review Score is 4.09**.
4. Approximately **3K repeat customers** are reported, representing a **3.1% repeat customer rate**.
